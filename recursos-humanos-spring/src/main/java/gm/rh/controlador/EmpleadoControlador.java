...
public class EmpleadoControlador {
    ...
    public ResponseEntity<Empleado> obtenerEmpleadoPorId(@PathVariable Integer id) {
        ...
        if (empleado == null) {
            throw new RecursoNoEncontradoExcepcion("Empleado no encontrado" + id);
        }else {
    ...
    public ResponseEntity<Empleado> actualizarEmpleado(@PathVariable Integer id, @RequestBody Empleado empleadoRecibido) {
        ...
        if (empleadoActual == null) {
            ...
            empleadoActual.setNombre(empleadoRecibido.getNombre());
            empleadoActual.setDepartamento(empleadoRecibido.getDepartamento());
            empleadoActual.setSueldo(empleadoRecibido.getSueldo());
